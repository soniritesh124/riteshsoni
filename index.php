...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      <h1>Ritesh Soni</h1>
      <p>I'm <span class="typed" data-typed-items="Computer Engineer, Entrepreneur, Developer, Freelancer"></span></p>
      <div class="social-links">
        <a href="https://twitter.com/soniritesh4" class="twitter"><i class="bx bxl-twitter"></i></a>
        <a href="https://www.facebook.com/people/Ritesh-Soni/100009667056074" class="facebook"><i class="bx bxl-facebook"></i></a>
        <a href="https://www.instagram.com/i_am_.ritesh/" class="instagram"><i class="bx bxl-instagram"></i></a>
        <a href="https://github.com/soniritesh124" class="github"><i class="bx bxl-github"></i></a>
        <a href="https://www.linkedin.com/in/soni-ritesh-374475126/" class="linkedin"><i class="bx bxl-linkedin"></i></a>
      </div>
    </div>
  </section><!-- End Hero -->
  ...
  <main id="main">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <!-- <li><i class="icofont-rounded-right"></i> <strong>Birthday:</strong> 28 August 1998</li> -->
                  <li><i class="icofont-rounded-right"></i> <strong>Blogger:</strong> https://robo-brain.blogspot.com/</li>
                  <li><i class="icofont-rounded-right"></i> <strong>Phone:</strong> +91 9723271716</li>
                  <li><i class="icofont-rounded-right"></i> <strong>City:</strong> Ahmedabad, India</li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="icofont-rounded-right"></i> <strong>Email:</strong> soniritesh124@gmail.com</li>
                  <li><i class="icofont-rounded-right"></i> <strong>Freelance:</strong> Available</li>
                </ul>
              </div>
            </div>
            <p>
              I am interested in new technology and new upcoming languages which have been developed recently and also the upcoming invention and personal invention ideas and I want to share all of these with the world. I love to share all new ideas and learn from others about the technology.
            </p>
          </div>
        </div>
    ...
    <section id="skills" class="skills section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Skills</h2>
          <p>Skill is the unified force of experience, intellect and passion in their operation. </p>
        </div>
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">Internet OF things<i class="val">100%</i></span>
            ...
            <div class="progress">
              <span class="skill">Computer Vision<i class="val">75%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill">MACHINE LEARNING / DEEP LEARNING<i class="val">50%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">C / C++<i class="val">50%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            ...
            <div class="progress">
              <span class="skill">CYBER SECURITY<i class="val">50%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
    ...
    <section id="resume" class="resume">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Resume</h2>
          <p>IoT & AI field fascinates me and wanted to explore and grow in the same. Willing to accept new challenges in this field which not only help the organization but also update & evolve my practical skills.</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="resume-item pb-0">
              <h4>Ritesh Soni</h4>
              <p><em>Myself Ritesh Soni and I would like to share my knowledge based on the field of IoT and Artificial Intelligence. Also, i have worked on multiple projects as mentioned in both the sections. I want to explore more in the same and want to help human kind by making easy and automated.</em></p>
              <ul>
                <li>Ahmedabad, India</li>
                <li>(+91) 9723271716</li>
                <li>soniritesh124@gmail.com</li>
              </ul>
            </div>
            ...
            <div class="resume-item">
              <h4>HSC(Science)</h4>
              <h5>2014 - 2015</h5>
              <p><em>Pooja School, Ahmedabad, Gujrat</em></p>
              <p>Field Of Interests:-<br> Physics, Chemistry, Mathematics</p>
            </div>
            <div class="resume-item">
...
<!--               <p><em>SenseQue Technologies Pvt. Ltd , Ahmedabad, Gujrat </em></p> -->
              <ul>
                ...
                <li>Also, other models of computer vision along with recoved library and alogrithms are completed.</li>
                <li>I have creates few projects based on AI and ML. They are as follows:
                Face mask recognition, Object Direction, Attendence system, Self-driving car lane detection</li>
              </ul>
            </div>
            <div class="resume-item">
              ...
              <p><em></em></p>
              <ul>
                <li>Internet of Things starts with hardware in which I have advanced level of knowledge </li>
                <li>In order to make hardware work according to our requirements, we need to program it in te same way.</li>
                <li>Also, the name itself suggests us that it needs online storage facility to store the data. I have knowledge of how to handle data on cloud as well.</li>
                <li>Projects built by me are Smart Dustbin facility, Smart home(with mobile app), Google assistant smart home and smart parking system.</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Portfolio</h2>
          <p>Engineers like to solve problems. If there are no problems handily available, they will create their own problems.</p>
        </div>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-IoT">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/IoT1.png" class="img-fluid" alt="">
...
<!--                   <a href="assets/img/portfolio/IoT1.png" data-gall="portfolioGallery" class="venobox" title="IOT 1"><i class="bx bx-plus"></i></a> -->
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-IoT">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/IoT2.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>IOT 2</h4>
                <p>Smart Dustbin</p>
                <div class="portfolio-links">
<!--                   <a href="assets/img/portfolio/IoT2.jpg" data-gall="portfolioGallery" class="venobox" title="IOT 2"><i class="bx bx-plus"></i></a> -->
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-IoT">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/IoT3.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>IOT 3</h4>
...
<!--                   <a href="assets/img/portfolio/IoT3.jpg" data-gall="portfolioGallery" class="venobox" title="IOT 3"><i class="bx bx-plus"></i></a> -->
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-IoT">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/IoT4.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>IOT 4</h4>
...
<!--                   <a href="assets/img/portfolio/IoT4.jpg" data-gall="portfolioGallery" class="venobox" title="IOT 4"><i class="bx bx-plus"></i></a> -->
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-IoT">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/IOT5.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>IOT 5</h4>
                <p>Smart Board</p>
                <div class="portfolio-links">
<!--                   <a href="assets/img/portfolio/IOT5.png" data-gall="portfolioGallery" class="venobox" title="IoT 5"><i class="bx bx-plus"></i></a> -->
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-IoT">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/IoT6.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>IOT 6</h4>
                <p>Arduino Music</p>
                <div class="portfolio-links">
<!--                   <a href="assets/img/portfolio/IoT6.png" data-gall="portfolioGallery" class="venobox" title="IoT 6"><i class="bx bx-plus"></i></a> -->
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-IoT">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/IoT7.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>IOT 7</h4>
...
<!--                   <a href="assets/img/portfolio/IoT7.png" data-gall="portfolioGallery" class="venobox" title="IoT 7"><i class="bx bx-plus"></i></a> -->
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-IoT">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/IoT8.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>IOT 8</h4>
                <p>RGB LED</p>
                <div class="portfolio-links">
...
<!--                   <a href="assets/img/portfolio/AI2.jpg" data-gall="portfolioGallery" class="venobox" title="AI 2"><i class="bx bx-plus"></i></a> -->
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-AI">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/AI3.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>AI 3</h4>
...
<!--                   <a href="assets/img/portfolio/AI3.png" data-gall="portfolioGallery" class="venobox" title="AI 3"><i class="bx bx-plus"></i></a> -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="owl-carousel testimonials-carousel" data-aos="zoom-in" data-aos-delay="100">
          ...
          <div class="testimonial-item">
            <img src="assets/img/testimonials/contact us logo.png" class="testimonial-img" alt="">
            <h3>Inferno Infosec</h3>
            <h4>Swapnil Ceo &amp; Founder</h4>
            <p>
              <i class="bx bxs-quote-alt-left quote-icon-left"></i>
              I am working as Technical Analyst there. The contribution of skills at inferno infosec are handling & checking up for website, develop and handle the core team for IoT, managing & training interns for IoT fied and giving training for certified IoT Expert course to the students who are enthusiastic for this field.
              <i class="bx bxs-quote-alt-right quote-icon-right"></i>
            </p>
          </div>

          <div class="testimonial-item">
            <img src="assets/img/testimonials/0.png" class="testimonial-img" alt="">
            <h3>Senseque Technologies</h3>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-1">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="contact-form.php" method="post" role="form" class="php-email-form">
              <div class="form-row">
  ...
  <footer id="footer">
    <div class="container">
      <h3>Ritesh Soni</h3>
      <p>Mind is a beautiful servant but a dangerous master.</p>
      <div class="social-links">
        <a href="https://twitter.com/soniritesh4" class="twitter"><i class="bx bxl-twitter"></i></a>
        <a href="https://www.facebook.com/people/Ritesh-Soni/100009667056074" class="facebook"><i class="bx bxl-facebook"></i></a>
        <a href="https://www.instagram.com/i_am_.ritesh/" class="instagram"><i class="bx bxl-instagram"></i></a>
      ...
      <!-- <div class="copyright">
        &copy; Copyright <strong><span>Ritesh Soni</span></strong>. All Rights Reserved
      </div> -->
      <div class="credits">
        ...
        Designed by <a href="">Ritesh Soni</a>
      </div>
    </div>
  </footer><!-- End Footer -->
